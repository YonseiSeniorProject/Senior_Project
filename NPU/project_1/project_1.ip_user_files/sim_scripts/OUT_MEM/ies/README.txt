...
#
# Generated by export_simulation on Thu Oct 30 22:31:37 +0900 2025
#
################################################################################
...
'-reset_run' switch to the './OUT_MEM.sh' script.

./OUT_MEM.sh -reset_run
...
./OUT_MEM.sh -noclean_files

For more information on the script, please type './OUT_MEM.sh -help'.
