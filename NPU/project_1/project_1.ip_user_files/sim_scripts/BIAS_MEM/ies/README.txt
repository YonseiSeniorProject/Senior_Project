...
#
# Generated by export_simulation on Sun Nov 23 13:44:23 +0900 2025
#
################################################################################
...
'-reset_run' switch to the './BIAS_MEM.sh' script.

./BIAS_MEM.sh -reset_run
...
./BIAS_MEM.sh -noclean_files

For more information on the script, please type './BIAS_MEM.sh -help'.
