...
#
# Generated by export_simulation on Tue Oct 07 01:28:31 +0900 2025
#
################################################################################
...
'-reset_run' switch to the './INPUT_MEM.sh' script.

./INPUT_MEM.sh -reset_run
...
./INPUT_MEM.sh -noclean_files

For more information on the script, please type './INPUT_MEM.sh -help'.
