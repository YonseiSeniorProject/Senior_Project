...
HD_PWD='C:/minsung/senior_project/git_works/Back_Up_1030/project_1/project_1.runs/OUT_MEM_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log OUT_MEM.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source OUT_MEM.tcl
