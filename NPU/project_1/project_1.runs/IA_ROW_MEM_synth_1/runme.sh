...
HD_PWD='C:/minsung/senior_project/git_works/Back_Up_1107/project_1/project_1.runs/IA_ROW_MEM_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log IA_ROW_MEM.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source IA_ROW_MEM.tcl
