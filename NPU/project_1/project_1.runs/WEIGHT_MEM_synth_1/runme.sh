...
HD_PWD='C:/minsung/senior_project/git_works/Senior_Project/NPU/project_1/project_1.runs/WEIGHT_MEM_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log WEIGHT_MEM.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source WEIGHT_MEM.tcl
