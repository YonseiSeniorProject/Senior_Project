...
HD_PWD='C:/minsung/senior_project/git_works/Senior_Project/NPU/project_1/project_1.runs/INPUT_MEM_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log INPUT_MEM.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source INPUT_MEM.tcl
