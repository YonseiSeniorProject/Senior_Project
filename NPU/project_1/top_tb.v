...
module top_tb;
    ...
    localparam ADDR_PSUM    = 12;  // ���� ���? �޸� �ּ� ��Ʈ
    localparam ADDR_OUT     = 15;  // ������ (���? �� ��)
...
//    localparam OUTPUT_MEM_DEPTH = 1 << ADDR_PSUM; // 2^12 = 4096
    ...
    reg [2:0] K;
    reg [9:0] IC;        // Max: 512 �� 10��Ʈ
    reg [5:0] IMG_H;
    reg [5:0] IMG_W;
    reg [7:0] OC;        // Max: 64 �� 8��Ʈ
    reg [3:0] shift_n;
    reg [2:0] STRIDE;
...
//        shift_n <= 4'd8;
    ...
    initial begin
        ...
        $readmemh("C:/minsung/senior_project/git_works/Back_Up_1107/project_1/3x3_s1_out_8bit_cols32.hex", answer_mem);  // �� ���� ���ϸ� ���� �ʿ�
